...
*Docker-compose* template:
    ...
    namenode:
      image: pnpritchard/hadoop-namenode
      hostname: namenode
...
*Docker-compose* template:
    ...
    datanode1:
      image: pnpritchard/hadoop-datanode
      hostname: datanode1
...
*Docker-compose* template:
    ...
    resourcemanager:
      image: pnpritchard/hadoop-resourcemanager
...
*Docker-compose* template:
    ...
    nodemanager1:
      image: pnpritchard/hadoop-nodemanager
...
pnpritchard/hadoop-spark <command>`.
...
*Docker-compose* template:
    ...
    spark:
      image: pnpritchard/hadoop-spark
      hostname: spark
